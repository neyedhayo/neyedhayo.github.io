    ...
    <div className="mb-24 animate-in fade-in slide-in-from-bottom-8 duration-700">
      ...
      <div className="space-y-1">
        {NEWS.map((item) => (
          ...
          >
            <div className="shrink-0 w-28 text-sm font-mono font-bold text-zinc-400 dark:text-zinc-500 uppercase tracking-wide group-hover:text-primary dark:group-hover:text-primary-dark transition-colors">
              {item.date}
            </div>
